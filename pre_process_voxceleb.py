...
def prep(libri,out_dir=c.DATASET_DIR,name='0'):
    ...
    for i in range(len(libri)):
        ...
        target_filename.apply(lambda x: x.replace('\\', '/'))
...
def test():
    ...
    filename = 'E:/mingde-AI/Deep_Speaker_exp3/Deep_Speaker_exp/audio/voxceleb/vox_test/id10001/1zcIwhmdeo4/00001.wav'
    #filename = filename.replace('\\', '/')
    #filename = os.path.normpath(filename)
    print(filename)
    #wav, _ = sf.read(filename)
...
if __name__ == '__main__':
    #test()
    #preprocess_sync(wav_dir='E:/mingde-AI/Deep_Speaker_exp3/Deep_Speaker_exp/audio/voxceleb/vox_train', out_dir='E:/mingde-AI/Deep_Speaker_exp3/Deep_Speaker_exp/audio/voxceleb/vox_train_npy')
    preprocess_sync(wav_dir='E:/mingde-AI/Deep_Speaker_exp3/Deep_Speaker_exp/audio/voxceleb/vox_test', out_dir='E:/mingde-AI/Deep_Speaker_exp3/Deep_Speaker_exp/audio/voxceleb/vox_test_npy')
